...
- o BAT usa versao explicita `v20260423-110620` e o JSON grava `server.collector_version`
...
2. Execute `powershell -ExecutionPolicy Bypass -File gamb-coletor\versions\new-collector-version.ps1 -SourceVersion v20260423-110620 -UseCurrentTimestamp`.
